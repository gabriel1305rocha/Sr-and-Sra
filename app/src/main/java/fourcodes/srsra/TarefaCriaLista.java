...
public class TarefaCriaLista {
    ...
    private static String[] tarefa9 = {"Momento do ensaio geral, com pais, padrinhos, noivos, damas de honra e pajens","Marque um encontro com o responsável pela música (DJ, banda ou músico(s)) e passe para ele(s) a lista de músicas que não podem faltar na sua festa","Marque um jantar com os pais e padrinhos, para depois do ensaio","O noivo deve combinar com alguém que possa levá-lo à cerimônia","Acerte todas as despesas do casamento até aqui","Confirme a reserva da viagem(hotel e passagem)"};
    private static String[] tarefa10 = {"Faça depilação","Faça as mãos e dos pés","As malas da lua mel devem estar prontas","Confirme o hórario e o local com o fotógrafo para as fotos do making of "};
    private static String[] tarefa11 = {"Neste dia, os noivo devem relaxar, ir ao salão de beleza ou centro estético e receber massagem","Confirme a entrega do buquê e das flores de lapela para o dia do casamento","Este é o prazo máximo para você buscar o vestido e os acessórios"};
    private static String[] tarefa12 = {"Pronto! Hoje é o grande dia. Curta cada momento e aproveite bastante porque passa muito rápido","Noivo, não esqueça das alianças","Sorriam e tirem muitas fotos!"};
    private static String[] tarefa13 = {"Lembre-se de enviar os cartões de agradecimento aos convidados pela presença e pelos presentes recebidos","Seja Feliz"};
